...
export const faqEntradas = [
  ...
  },
  {
    ...
    answer: 'No, deberás guardar el único tipo de entrada disponible. Pero deberás marcar el recuadro indicado para personas con discapacidad. Contamos con los siguientes servicios adaptados: Servicios internos como baños para discapacitados, Neveras para medicinas, Electricidad para cargar sillas de ruedas electrónicas, Ubicaciones dedicadas para ver los conciertos, Servicios de transporte, Alquiler de silla de ruedas, Asistencia a personas con discapacidad visual, Solicitudes disponibles para intérpretes internacionales y de lenguas de signos.'
  },
  {
    question: '¿Cómo funciona el sistema de check-in en las entradas?',
    answer: 'Para garantizar la seguridad de todos los asistentes, ESCLAT cuenta con un sistema de control fotográfico y de identidad en los accesos. Al entrar, el personal de seguridad verificará que el código QR corresponda con el nombre de tu DNI o pasaporte. El proceso es rápido, pero te recomendamos llegar con antelación y tener tu documentación a mano.'
  },
  {
    question: 'Tengo mi entrada y finalmente no puedo asistir. ¿Qué hago con mi entrada?',
    answer: 'Sé responsable y devuélvela, en la seccion de entradas tenemos un apartado de devolucion donde solo deberas introducir el gmail con el que las compraste, te enviaremos un codigo para verificar que es tu gmail y lo demas lo solucionamos nosotros.'
  },
  {
    question: 'No puedo ir, ¿le puedo dar mi entrada a un amigo?',
    answer: 'Si escríbenos un gmail a esclatproblemas@gmail.com indicando tu nombre apellidos y gmail y el de la persona a la que quieres transferirselas y gestionaremos el cambio, el mismo qr seguira siendo valido.'
  }
]

export const faqComidaBebida = [
  {
    question: '¿Habrá agua gratis?',
    answer: 'Sí, en ESCLAT nos comprometemos con las personas, el recinto dispondrá de dos fuentes, una en cada patio, en las que podrás beber o rellenar tu cantimplora.'
  },
  {
    question: '¿Habrá bar o barra?',
    answer: '¡Sí! Las naves cuentan con una cafetería en el primer piso, que sirve todo tipo de bebidas y comida. Además, montaremos una barra en el patio 2, accesible para todo el mundo.'
  },
  {
    question: '¿Se puede pagar con tarjeta?',
    answer: 'Sí, se aceptarán pagos con tarjeta en todos los puntos de venta del festival para tu comodidad.'
  },
  {
    question: '¿Se puede comer allí?',
    answer: 'Sí, en la cafetería situada en la primera planta dispondrás de un espacio cómodo habilitado para consumir alimentos.'
  },
  {
    question: '¿Me puedo traer mi propia comida y bebida?',
    answer: 'Sí, se puede llevar una botella con un máximo de 2 litros de agua embotellada. Por favor, no tires envases al suelo, ESCLAT está concienciado con el medio ambiente y dispone de múltiples papeleras por todo el recinto. Puedes traer comida en cantidades no comerciales. Si superas los límites, los productos restantes deben entregarse al servicio de seguridad en la entrada.'
  }
]
...
export const faqUtil = [
  {
    ...
    answer: 'Sí, pidiendo en recepción una pulsera identificatoria. Este servicio tiene un precio de 2 euros.'
  },
  {
    question: '¿Está permitido fumar?',
    answer: 'Está prohibido fumar dentro del recinto, incluido patios. Para poder entrar y salir con libertad tendrás que pedir una pulsera de 2 euros en recepción.'
  },
  {
    question: '¿Puedo llevar a mi mascota?',
    answer: 'Además de los perros de asistencia según lo definido por la ley, los perros guía y los perros policía, no está permitido llevar mascotas al festival por su propio bien, ya que no es un ambiente adecuado dado el alto nivel de ruido y la gran cantidad de gente que podrán encontrar.'
  }
]
