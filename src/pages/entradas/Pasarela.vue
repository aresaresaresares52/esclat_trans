...
<template>
  <div class="min-h-screen bg-black text-white py-16 px-4 md:px-8 font-sans">
    <div class="max-w-xl mx-auto bg-white text-black border-4 border-black p-6 md:p-10 shadow-[12px_12px_0_0_#16a0db]">
      ...
      <div class="flex items-center justify-between border-b-4 border-black pb-6 mb-8">
        <h1 class="text-3xl font-extrabold uppercase tracking-tight">
          <span class="bg-[#fff200] px-2 py-1 border-2 border-black inline-block -rotate-2">ESCLAT</span> PASARELA
        </h1>
        <button 
          @click="closeWindow" 
      ...
      <div v-if="tipo === 'compra'">
        ...
        <div v-if="isSubmitted" class="text-center py-6 space-y-6">
          <div class="inline-flex items-center justify-center bg-[#15a64b] border-4 border-black p-4 rounded-none -rotate-1">
            <CheckCircle2 :size="48" class="text-white" />
          </div>
          <h2 class="text-3xl font-black uppercase text-[#15a64b]">¡RESERVA COMPLETADA!</h2>
          <div class="bg-[#fff200] border-4 border-black p-6 text-left space-y-3 font-mono shadow-[6px_6px_0_0_#7b4a9d]">
          ...
          <button 
            @click="closeWindow" 
            class="w-full bg-black text-white font-extrabold text-xl py-4 uppercase border-4 border-black hover:bg-[#16a0db] hover:text-black transition-colors shadow-[6px_6px_0_0_#fff200]"
          >
            Finalizar y Cerrar
          </button>
        </div>
        ...
        <div v-else class="space-y-6">
          <div class="bg-[#fff200]/10 border-2 border-black p-4 mb-4">
            <div class="flex items-center gap-3">
              <Ticket :size="24" class="text-[#fff200] shrink-0" />
              <div>
          ...
          <h2 class="text-2xl font-black uppercase text-[#16a0db] border-b-2 border-black pb-2 mb-4">
            Datos Personales
          </h2>
          ...
          <form @submit.prevent="handleCompraSubmit" class="space-y-4">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <input 
                  v-model="form.nombre" 
                  type="text" 
                  class="w-full border-2 border-black p-2.5 font-bold focus:bg-[#fff200]/10 focus:outline-none" 
            ...
            <div class="bg-gray-100 border-2 border-black p-4 space-y-2">
              ...
              <div class="flex items-center gap-4">
                ...
                <input 
                  ...
                  type="number" 
                  class="w-24 border-2 border-black p-1.5 font-bold text-center focus:bg-[#fff200]/10 focus:outline-none"
                  placeholder="?"
                  required
                />
              </div>
            ...
            <button 
              type="submit" 
              class="w-full bg-[#fff200] text-black font-extrabold text-xl py-4 uppercase border-4 border-black hover:bg-[#16a0db] hover:text-black transition-all shadow-[6px_6px_0_0_#7b4a9d] hover:shadow-[3px_3px_0_0_#7b4a9d] hover:translate-x-[3px] hover:translate-y-[3px] cursor-pointer mt-4"
            >
      ...
      <div v-else>
        ...
        <div v-if="returnSubmitted" class="text-center py-6 space-y-6">
          <div class="inline-flex items-center justify-center bg-[#7b4a9d] border-4 border-black p-4 rounded-none -rotate-1">
            <RotateCcw :size="48" class="text-white" />
          </div>
          <h2 class="text-3xl font-black uppercase text-[#7b4a9d]">DEVOLUCIÓN TRAMITADA</h2>
          <div class="bg-gray-100 border-4 border-black p-6 text-left space-y-3 font-mono shadow-[6px_6px_0_0_#16a0db]">
            <p class="font-bold">
              Las plazas para <span class="text-[#7b4a9d] font-black">{{ ticketName }}</span> han sido liberadas con éxito.
            </p>
            <p class="text-sm">
          ...
          <button 
            @click="closeWindow" 
            class="w-full bg-black text-white font-extrabold text-xl py-4 uppercase border-4 border-black hover:bg-[#7b4a9d] hover:text-white transition-colors shadow-[6px_6px_0_0_#fff200]"
          >
            Finalizar y Cerrar
          </button>
        </div>
        ...
        <!-- Flujo de Devolución -->
        <div v-else class="space-y-6">
          <div class="bg-[#7b4a9d]/10 border-2 border-black p-4 mb-4">
            <div class="flex items-center gap-3">
              <RotateCcw :size="24" class="text-[#7b4a9d] shrink-0" />
              <div>
          ...
          <h2 class="text-2xl font-black uppercase text-[#7b4a9d] border-b-2 border-black pb-2 mb-4">
          ...
          <div v-if="returnStep === 1" class="space-y-4">
            <div>
              ...
              <input 
                ...
                type="email" 
                class="w-full border-2 border-black p-2.5 font-bold focus:bg-[#7b4a9d]/10 focus:outline-none" 
                placeholder="Ej: laura.garcia@gmail.com"
                required
              />
            </div>
            ...
            <button 
              ...
              class="w-full bg-[#7b4a9d] text-white font-extrabold text-xl py-4 uppercase border-4 border-black hover:bg-black hover:text-[#7b4a9d] transition-all shadow-[6px_6px_0_0_#fff200] hover:shadow-[3px_3px_0_0_#fff200] hover:translate-x-[3px] hover:translate-y-[3px] cursor-pointer"
            >
          ...
          <div v-else class="space-y-4">
            <div class="bg-[#fff200]/10 border-2 border-black p-4 text-xs font-bold uppercase text-[#7b4a9d]">
            ...
            <div>
              ...
              <input 
                ...
                type="text" 
                maxlength="6"
                class="w-full border-2 border-black p-2.5 font-mono font-extrabold text-center text-2xl tracking-widest focus:bg-[#7b4a9d]/10 focus:outline-none" 
                placeholder="------"
                required
              />
            </div>
            ...
            <button 
              ...
              class="w-full bg-[#fff200] text-black font-extrabold text-xl py-4 uppercase border-4 border-black hover:bg-[#7b4a9d] hover:text-white transition-all shadow-[6px_6px_0_0_#16a0db] hover:shadow-[3px_3px_0_0_#16a0db] hover:translate-x-[3px] hover:translate-y-[3px] cursor-pointer"
            >
              Tramitar devolución
            </button>
            ...
            <button 
              @click="returnStep = 1" 
              class="w-full bg-transparent text-black font-bold text-sm py-2 uppercase underline hover:text-[#7b4a9d] transition-colors"
            >
