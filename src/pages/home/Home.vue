...
<template>
  <div class="min-h-screen font-sans bg-[#111111] text-white pb-32 overflow-x-hidden w-full">
    ...
    <section class="min-h-[80vh] flex flex-col items-center justify-center text-center px-4 relative mb-20 w-full bg-[#111111]">
    ...
    <section class="max-w-7xl mx-auto px-4 md:px-8 py-32 mb-32 w-full bg-[#111111]">
